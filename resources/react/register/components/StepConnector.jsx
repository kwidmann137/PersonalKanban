...
class StepConnector extends React.Component {
  ...
  render() {
    ...
    let step2Props = {};
    let step3Props = {};
    if(this.props.errors.first_name.length > 0 || this.props.errors.last_name.length > 0){
      step1Props = {
    ...
    if(this.props.errors.password.length > 0 || this.props.errors.confirm_password.length > 0){
      step3Props = {
        icon: <WarningIcon color={red500} />,
        style: {color: red500}
      }
